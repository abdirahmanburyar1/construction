  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <Link href="/admin/tenants" className="mt-4 inline-flex rounded-lg bg-teal-600 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-teal-700">
          Manage tenants
        </Link>
      </div>
    </div>
